...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#242239] text-white py-12 px-8 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4 mt-2">
              <Link href="https://www.facebook.com/johnenglishonline" target="_blank" className="text-gray-300 hover:text-[#7FDEFF] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/r/demo" className="text-gray-300 hover:text-white transition-colors">
                  Toma una clase demo
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <Link href="/r/contact" className="text-gray-300 hover:text-white transition-colors">
                  (+34) 613 69 68 39
                </Link>
              </li>
