        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#toma-una-demo" className="text-gray-300 hover:text-white transition-colors">
                  Toma una clase demo
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:admin@johnenglish.online" className="text-gray-300 hover:text-white transition-colors">
                  admin@johnenglish.online
                </a>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-[#7FDEFF]" viewBox="0 0 16 16">
